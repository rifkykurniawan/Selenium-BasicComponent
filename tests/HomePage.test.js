...
describe('Click each menu', function() {
    ...
    it('TC8 - Verify click Disappearing Elements', async () => {
    ...
    it('TC12 - Verify click Dynamic Controls', async () => {
    ...
    it('TC13 - Verify click Dynamic Loading', async () => {
    ...
    it('TC20 - Verify click Form Authentication', async () => {  
        this.timeout(100000);      
    ...
    it('TC26 - Verify click Javacript onload', async () => {        
    ...
    it('TC27 - Verify click Key Presses', async () => {        
    ...
    it('TC34 - Verify click Shifting Content', async () => {        
